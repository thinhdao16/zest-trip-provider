...
}: // setLoading,
{
  ...
  const shouldDisableDate = (date: any) => {
    const disableDate = dataDetailTour;
  ...
  const handleAddAvailability = () => {
    ...
    const newData = {
      ...
      special_dates: formattedStartingTimes?.SingleTime?.map((single: any) => ({
        date: single?.day,
        timeSlot: single?.time,
      })),
      weekdays: [
        ...(formattedStartingTimes?.Sun?.length > 0
          ? [
              {
                day: 1,
                timeSlot: formattedStartingTimes?.Sun,
              },
            ]
          : []),
        ...(formattedStartingTimes?.Mon?.length > 0
          ? [
              {
                day: 2,
                timeSlot: formattedStartingTimes?.Mon,
              },
            ]
          : []),
        ...(formattedStartingTimes?.Tue?.length > 0
          ? [
              {
                day: 3,
                timeSlot: formattedStartingTimes?.Tue,
              },
            ]
          : []),
        ...(formattedStartingTimes?.Wed?.length > 0
          ? [
              {
                day: 4,
                timeSlot: formattedStartingTimes?.Wed,
              },
            ]
          : []),
        ...(formattedStartingTimes?.Thu?.length > 0
          ? [
              {
                day: 5,
                timeSlot: formattedStartingTimes?.Thu,
              },
            ]
          : []),
        ...(formattedStartingTimes?.Fri?.length > 0
          ? [
              {
                day: 6,
                timeSlot: formattedStartingTimes?.Fri,
              },
            ]
          : []),
        ...(formattedStartingTimes?.Sat?.length > 0
          ? [
              {
                day: 7,
                timeSlot: formattedStartingTimes?.Sat,
              },
            ]
          : []),
      ],
